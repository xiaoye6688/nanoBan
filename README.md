...
基于 Electron + Vue 3 + TypeScript + Element Plus 构建的 Google Gemini-3-pro-image-preview 图像生成桌面应用。
...
1. **设置认证**: 首次使用需要先设置 API Key 或完成 OAuth 授权
2. **配置参数**: 在左侧面板选择所需的分辨率和宽高比
3. **输入提示词**: 在底部输入框中描述您想要生成的图像
4. **生成图片**: 点击"生成图片"按钮或按 Ctrl+Enter
